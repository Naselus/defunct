NDefines = {
	...
	NGameplay = {
		...
		CORE_SECTOR_PLANET_CAP					= 75,	-- Too many planets in core sector will apply modifier inefficient_planet_management.
		SECTOR_CAP								= 20,	-- Too many sectors will apply modifier inefficient_sector_management.
		...
		SECTOR_REVOKE_PLANET_COST				= 0,	-- Influence cost for revoking a planet from a sector
	...
	NPop = {
		...
		FOOD_SURPLUS_EXTRA_GROWTH 			= 0,	-- Amount to grow per food surplus over 1
	...
	NEconomy = {
		...
		MINING_STATION_MAINTENANCE 			= 0,		-- Monthly mining station maintenance
		RESEARCH_STATION_MAINTENANCE 		= 0,		-- Monthly research station maintenance
		ORBITAL_STATION_MAINTENANCE			= 0, 		-- Monthly orbital station maintenance cost
		TERRAFORM_STATION_MAINENANCE		= 0.0,		-- Monthly terraform station maintenance
		WORMHOLE_STATION_MAINTENANCE 		= 0,		-- Monthly wormhole station maintenance
